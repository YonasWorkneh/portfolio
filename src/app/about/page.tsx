...
export default function Page() {
  ...
  return (
    <Curve>
      <main className="2xl:max-w-[1440px] lg:max-w-[1080px] lg:pt-28  mx-auto 2xl:pt-48 bg-[radial-gradient(circle_closest-corner_at_50%_0,#36363625,#0000)] min-h-screen">
