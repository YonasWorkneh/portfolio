        ...
        >
          ...
          >
            <p className="text-white/50 font-tenor">
              ...
              primary purpose. For a law firm, that means ensuring the focus
              remains on its credibility, expertise, and services, rather than
              just aesthetics. The goal is not simply to create a visually
